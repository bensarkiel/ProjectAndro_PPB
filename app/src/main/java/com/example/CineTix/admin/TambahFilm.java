...
public class TambahFilm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_tambah_film);
    ...
    public void validate(){
        ...
        if (imagePath == null){
            ...
            com.example.CineTix.admin.model.TambahFilm addShow = new com.example.CineTix.admin.model.TambahFilm(id,MovieName,Language,DirectorName,CastName,CateGory,TimIng,AvailableSeat,TheatreAddress,TheatreName,TheatrePrice);
            databaseReference.child(id).setValue(addShow).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void aVoid) {
                    Toast.makeText(TambahFilm.this,"Upload show successful",Toast.LENGTH_SHORT).show();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(TambahFilm.this," Something is wrong show not uploaded ",Toast.LENGTH_SHORT).show();
                }
            });
            finish();
        }
