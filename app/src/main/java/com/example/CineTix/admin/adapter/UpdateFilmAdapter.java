...
public class UpdateFilmAdapter extends FirebaseRecyclerAdapter<TambahFilm, UpdateFilmAdapter.myViewHolder> {
     ...
     * @param options
     */
    public UpdateFilmAdapter(@NonNull FirebaseRecyclerOptions<TambahFilm> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(final @NonNull myViewHolder holder, int position, final  @NonNull TambahFilm model) {
            ...
            public void onClick(View view) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        TambahFilm addShow = snapshot.getValue(TambahFilm.class);
                    ...
                    public void onClick(View v) {
                        ...
                        String Price = editText10.getText().toString();
                         ...
                         if (TextUtils.isEmpty(MovieName)) {
                            ...
                            databaseReference = FirebaseDatabase.getInstance().getReference("Add Show").child(id);
                            TambahFilm addShow = new TambahFilm(id,MovieName,Lang,Director,Cast,Category,Time,Seat,Address,Theatre,Price);
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UpdateFilmAdapter.myViewHolder(view);
    }
