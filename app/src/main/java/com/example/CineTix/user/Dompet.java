...
public class Dompet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_dompet);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Akun account = snapshot.getValue(Akun.class);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Dompet.this, error.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        changePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final BottomSheetDialog view = new BottomSheetDialog(Dompet.this);
                                    ...
                                    if(OldPassword.equals(Password)){
                                        databaseReference.child("accountPassword").setValue(NewPassword).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                Toast.makeText(Dompet.this, "Password successfully change", Toast.LENGTH_SHORT).show();
                                                view.dismiss();
                                            }
                                        }).addOnFailureListener(new OnFailureListener() {
                                            @Override
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(Dompet.this, "Something is wrong password not updated !!!", Toast.LENGTH_SHORT).show();
                                                view.dismiss();
                                            }
                                        });
                                    }else {
                        ...
                        if (TextUtils.isEmpty(DepositAmount)){
                            ...
                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    Toast.makeText(Dompet.this, "Amount added successfully", Toast.LENGTH_SHORT).show();
                                    view.dismiss();
                                }
