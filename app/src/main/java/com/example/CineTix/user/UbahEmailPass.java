...
public class UbahEmailPass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ubah_email_pass);
                    ...
                    firebaseUser.updateEmail(Email).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(UbahEmailPass.this,"Email successfully changed",Toast.LENGTH_SHORT).show();
                                finish();
                            }else {
                                progressDialog.dismiss();
                                Toast.makeText(UbahEmailPass.this,"Email update failed",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                ...
                if (TextUtils.isEmpty(Password)){
                    ...
                    firebaseUser.updatePassword(Password).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                progressDialog.dismiss();
                                Toast.makeText(UbahEmailPass.this,"Password successfully changed",Toast.LENGTH_SHORT).show();
                                finish();
                            }else {
                                progressDialog.dismiss();
                                Toast.makeText(UbahEmailPass.this,"Password update failed",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
