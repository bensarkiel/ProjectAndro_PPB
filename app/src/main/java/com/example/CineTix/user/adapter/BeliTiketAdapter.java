package com.example.CineTix.user.adapter;
...
import com.example.CineTix.user.model.HargaFilm;
...
public class BeliTiketAdapter extends FirebaseRecyclerAdapter<TambahFilm, BeliTiketAdapter.myViewHolder> {
    ...
    public BeliTiketAdapter(@NonNull FirebaseRecyclerOptions<TambahFilm> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final myViewHolder holder, final int position, @NonNull final TambahFilm model) {
                        ...
                        public void onClick(View v) {
                            ...
                            if (TextUtils.isEmpty(Booking_Seat)){
                                ...
                                if (booking_Seat2 > AvailableSeat){
                                    ...
                                    HargaFilm moviePrice = new HargaFilm(T_price);
                                                ...
                                                databaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
                                                    ...
                                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                        ...
                                                        if (!Name.equals(HolderName)){
                                                            ...
                                                            LihatTiket view_booking = new LihatTiket(id,MovieId,MovieName,UserName,ShowTime,Booking_Seat);
